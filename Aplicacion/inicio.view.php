...
<head>
    ...
    <title>CUI - Modulo Administrador</title>
...
<body>
    ...
    <header class="header">
		<div class="container">
		    <div class="btn-menu">
			    ...
			    <nav class="menu">
                    <h5>Administrador</h5>
				    <a href="logout.php" class="m">Cerrar Sesión </a>
			    </nav>
		</div>
	</header>
    ...
    <input type="checkbox" id="btn-menu">
        ...
        <div class="container-menu">
	        <div class="cont-menu">
		        <nav>
			        <a href="#" class="m">Curso</a>
			        <a href="#" class="m">Materias</a>
			        <a href="#" class="m">Docente</a>
			        <a href="#" class="m">Estudiante</a>
			        <a href="#" class="m">Asignaciones</a>
		        </nav>
