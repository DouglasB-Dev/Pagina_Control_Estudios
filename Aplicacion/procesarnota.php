...
if(!$_POST){
    ...
    if (isset($_POST['insertar'])){
        ...
        if (isset($result)) {
            header('location:registro_notas.php?grado='.$id_grado.'&materia='.$id_materia.'&seccion='.$id_seccion.'&revisar=1&info=1');
        } else {
            header('location:registro_notas.php?grado='.$id_grado.'&materia='.$id_materia.'&seccion='.$id_seccion.'&revisar=1&err=1');
